...
export default function ScoreBadge({ score }: ScoreBadgeProps) {
  ...
  return (
    <div className="relative flex size-36 shrink-0 items-center justify-center rounded-full p-2 shadow-[0_15px_45px_rgba(22,135,255,.16)] transition-[background] duration-700 sm:size-40" style={{ background: colors.ring }} aria-label={`Risk score ${score} out of 100`}>
